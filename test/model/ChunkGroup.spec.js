...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrieveJsTsClient.ChunkGroup();
  });
  ...
  describe('ChunkGroup', function() {
    it('should create an instance of ChunkGroup', function() {
      // uncomment below and update the code to test ChunkGroup
      //var instance = new TrieveJsTsClient.ChunkGroup();
      //expect(instance).to.be.a(TrieveJsTsClient.ChunkGroup);
    });
