...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrieveJsTsClient.FieldCondition();
  });
  ...
  describe('FieldCondition', function() {
    it('should create an instance of FieldCondition', function() {
      // uncomment below and update the code to test FieldCondition
      //var instance = new TrieveJsTsClient.FieldCondition();
      //expect(instance).to.be.a(TrieveJsTsClient.FieldCondition);
    });
