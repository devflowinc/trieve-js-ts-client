...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrieveJsTsClient.UserOrganization();
  });
  ...
  describe('UserOrganization', function() {
    it('should create an instance of UserOrganization', function() {
      ...
      //var instance = new TrieveJsTsClient.UserOrganization();
      //expect(instance).to.be.a(TrieveJsTsClient.UserOrganization);
    });
