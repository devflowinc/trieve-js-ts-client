...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrieveJsTsClient.BookmarkData();
  });
  ...
  describe('BookmarkData', function() {
    it('should create an instance of BookmarkData', function() {
      // uncomment below and update the code to test BookmarkData
      //var instance = new TrieveJsTsClient.BookmarkData();
      //expect(instance).to.be.a(TrieveJsTsClient.BookmarkData);
    });
