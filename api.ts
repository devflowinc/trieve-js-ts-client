 ...
 *
 * @export
 * @interface ChunkMetadataWithFileData
 */
export interface ChunkMetadataWithFileData {
  /**
   *
   * @type {string}
   * @memberof ChunkMetadataWithFileData
   */
  chunk_html?: string | null;
  /**
   *
 ...
 *
 * @export
 * @interface GroupScoreChunkDTO
 */
export interface GroupScoreChunkDTO {
  /**
   *
   * @type {string}
   * @memberof GroupScoreChunkDTO
   */
  group_id: string;
  /**
   *
 ...
 *
 * @export
 * @interface GroupSlimChunksDTO
 */
export interface GroupSlimChunksDTO {
  /**
   *
   * @type {string}
   * @memberof GroupSlimChunksDTO
   */
  group_id: string;
  /**
   *
 ...
 *
 * @export
 * @interface ReccomendGroupChunksRequest
 */
export interface ReccomendGroupChunksRequest {
  /**
   *
   * @type {ChunkFilter}
...
/**
 * @type RecommendChunksResponseTypes
 * @export
 */
export type RecommendChunksResponseTypes =
  | Array<ChunkMetadata>
  | Array<SlimChunkMetadata>;

/**
 * @type RecommendGroupChunkResponseTypes
 * @export
 */
export type RecommendGroupChunkResponseTypes =
...
/**
 * @type SearchChunkResponseTypes
 * @export
 */
export type SearchChunkResponseTypes =
 ...
 *
 * @export
 * @interface SearchGroupSlimChunksResult
 */
export interface SearchGroupSlimChunksResult {
  /**
   *
   * @type {Array<ScoreSlimChunks>}
   * @memberof SearchGroupSlimChunksResult
   */
...
export interface SearchOverGroupsResponseBody {
  /**
   *
   * @type {Array<GroupScoreChunkDTO>}
   * @memberof SearchOverGroupsResponseBody
   */
  group_chunks: Array<GroupScoreChunkDTO>;
  /**
   *
   * @type {number}
   * @memberof SearchOverGroupsResponseBody
 ...
 * @export
 */
export type SearchOverGroupsResponseTypes =
 ...
 *
 * @export
 * @interface SearchOverGroupsSlimChunksResponseBody
 */
export interface SearchOverGroupsSlimChunksResponseBody {
  /**
   *
   * @type {Array<GroupSlimChunksDTO>}
   * @memberof SearchOverGroupsSlimChunksResponseBody
   */
...
/**
 * @type SearchWithinGroupResponseTypes
 * @export
 */
export type SearchWithinGroupResponseTypes =
...
export const AuthApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @summary Login
     * @param {AuthQuery} content Query parameters for login to be included as kv pairs after ? on the request URL.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    login: async (
      ...
      assertParamExists("login", "content", content);
...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async callback(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SlimUser>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.callback(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AuthApi.callback"]?.[localVarOperationServerIndex]
          ?.url;
...
export const AuthApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    login(content: AuthQuery, options?: any): AxiosPromise<void> {
      return localVarFp
...
export class AuthApi extends BaseAPI {
   ...
   * @memberof AuthApi
   */
  public login(content: AuthQuery, options?: RawAxiosRequestConfig) {
    return AuthApiFp(this.configuration)
      .login(content, options)
      .then((request) => request(this.axios, this.basePath));
  }
 ...
 * @export
 */
export const ChunkApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    createSuggestedQueriesHandler: async (
      tRDataset: string,
    ...
    deleteChunk: async (
      ...
      const localVarPath = `/api/chunk/{chunk_id}`.replace(
        `{${"chunk_id"}}`,
        encodeURIComponent(String(chunkId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    deleteChunkByTrackingId: async (
      ...
      const localVarPath = `/api/chunk/tracking_id/{tracking_id}`.replace(
        `{${"tracking_id"}}`,
  ...
  return {
    ...
    async createChunk(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ReturnQueuedChunk>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createChunk(
        tRDataset,
        createChunkData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.createChunk"]?.[
     ...
     * @throws {RequiredError}
     */
    async createSuggestedQueriesHandler(
      tRDataset: string,
      suggestedQueriesRequest: SuggestedQueriesRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SuggestedQueriesResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createSuggestedQueriesHandler(
          tRDataset,
          suggestedQueriesRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.createSuggestedQueriesHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async deleteChunk(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteChunk(
        tRDataset,
        chunkId,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.deleteChunk"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteChunkByTrackingId(
          tRDataset,
          trackingId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.deleteChunkByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.generateOffChunks(
          tRDataset,
          generateChunksRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.generateOffChunks"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getChunkById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChunkMetadata>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getChunkById(
        tRDataset,
        chunkId,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.getChunkById"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getChunkByTrackingId(
          tRDataset,
          trackingId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.getChunkByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getRecommendedChunks(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RecommendChunksResponseTypes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getRecommendedChunks(
          tRDataset,
          recommendChunksRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.getRecommendedChunks"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async searchChunk(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SearchChunkResponseTypes>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.searchChunk(
        tRDataset,
        searchChunkData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.searchChunk"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async updateChunk(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateChunk(
        tRDataset,
        updateChunkData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.updateChunk"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateChunkByTrackingId(
          tRDataset,
          updateChunkByTrackingIdData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkApi.updateChunkByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const ChunkApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    createChunk(
      ...
      return localVarFp
        .createChunk(tRDataset, createChunkData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Generate suggested queries  This endpoint will generate 3 suggested queries based off the query provided in the request body and return them as a JSON object.
    ...
    deleteChunk(
      ...
      return localVarFp
        .deleteChunk(tRDataset, chunkId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete Chunk By Tracking Id  Delete a chunk by tracking_id. This is useful for when you are coordinating with an external system and want to use the tracking_id to identify the chunk. If deleting a root chunk which has a collision, the most recently created collision will become a new root chunk.
    ...
    deleteChunkByTrackingId(
      ...
      return localVarFp
        .deleteChunkByTrackingId(tRDataset, trackingId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * RAG on Specified Chunks  This endpoint exists as an alternative to the topic+message concept where our API handles chat memory. With this endpoint, the user is responsible for providing the context window and the prompt. See more in the \"search before generate\" page at docs.trieve.ai.
    ...
    generateOffChunks(
      ...
      return localVarFp
        .generateOffChunks(tRDataset, generateChunksRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Chunk By Id  Get a singular chunk by id.
    ...
    getChunkById(
      ...
      chunkId: string,
      options?: any,
    ): AxiosPromise<ChunkMetadata> {
      return localVarFp
        .getChunkById(tRDataset, chunkId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Chunk By Tracking Id  Get a singular chunk by tracking_id. This is useful for when you are coordinating with an external system and want to use your own id as the primary reference for a chunk.
    ...
    getChunkByTrackingId(
      ...
      return localVarFp
        .getChunkByTrackingId(tRDataset, trackingId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Recommended Chunks  Get recommendations of chunks similar to the chunks in the request. Think about this as a feature similar to the \"add to playlist\" recommendation feature on Spotify. This request pairs especially well with our groups endpoint.
    ...
    getRecommendedChunks(
      ...
      return localVarFp
        .getRecommendedChunks(tRDataset, recommendChunksRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Search  This route provides the primary search functionality for the API. It can be used to search for chunks by semantic similarity, full-text similarity, or a combination of both. Results\' `chunk_html` values will be modified with `<b>` tags for sub-sentence highlighting.
    ...
    searchChunk(
      ...
      return localVarFp
        .searchChunk(tRDataset, searchChunkData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update Chunk  Update a chunk. If you try to change the tracking_id of the chunk to have the same tracking_id as an existing chunk, the request will fail.
    ...
    updateChunk(
      ...
      return localVarFp
        .updateChunk(tRDataset, updateChunkData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update Chunk By Tracking Id  Update a chunk by tracking_id. This is useful for when you are coordinating with an external system and want to use the tracking_id to identify the chunk.
...
export class ChunkApi extends BaseAPI {
  ...
  public createChunk(
    ...
    return ChunkApiFp(this.configuration)
      .createChunk(tRDataset, createChunkData, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ChunkApi
   */
  public createSuggestedQueriesHandler(
    tRDataset: string,
    suggestedQueriesRequest: SuggestedQueriesRequest,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof ChunkApi
   */
  public deleteChunkByTrackingId(
    tRDataset: string,
    trackingId: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof ChunkApi
   */
  public updateChunkByTrackingId(
    tRDataset: string,
    updateChunkByTrackingIdData: UpdateChunkByTrackingIdData,
    options?: RawAxiosRequestConfig,
  ) {
    return ChunkApiFp(this.configuration)
      .updateChunkByTrackingId(tRDataset, updateChunkByTrackingIdData, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
 ...
 * @export
 */
export const ChunkGroupApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
    ...
    addChunkToGroup: async (
      ...
      const localVarPath = `/api/chunk_group/chunk/{group_id}`.replace(
        `{${"group_id"}}`,
     ...
     * @throws {RequiredError}
     */
    addChunkToGroupByTrackingId: async (
      tRDataset: string,
      trackingId: string,
      addChunkToGroupData: AddChunkToGroupData,
      options: RawAxiosRequestConfig = {},
      ...
      const localVarPath = `/api/chunk_group/tracking_id/{tracking_id}`.replace(
        `{${"tracking_id"}}`,
        encodeURIComponent(String(trackingId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteChunkGroup: async (
      ...
      const localVarPath = `/api/chunk_group/{group_id}`.replace(
        `{${"group_id"}}`,
        encodeURIComponent(String(groupId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getChunksInGroupByTrackingId: async (
      tRDataset: string,
      ...
      const localVarPath =
        `/api/chunk_group/tracking_id/{group_tracking_id}/{page}`
          .replace(
            `{${"group_tracking_id"}}`,
            encodeURIComponent(String(groupTrackingId)),
          )
          .replace(`{${"page"}}`, encodeURIComponent(String(page)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
     ...
     * @param {string} tRDataset The dataset id to use for the request
     * @param {ReccomendGroupChunksRequest} reccomendGroupChunksRequest JSON request payload to get recommendations of chunks similar to the chunks in the request
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getRecommendedGroups: async (
      ...
      // verify required parameter 'reccomendGroupChunksRequest' is not null or undefined
      assertParamExists(
     ...
     * @throws {RequiredError}
     */
    getSpecificDatasetChunkGroups: async (
      tRDataset: string,
      datasetId: string,
      page: number,
      options: RawAxiosRequestConfig = {},
...
export const ChunkGroupApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ChunkGroupApiAxiosParamCreator(configuration);
  return {
    /**
     * Add Chunk to Group  Route to add a chunk to a group.
     * @summary Add Chunk to Group
    ...
    async addChunkToGroup(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addChunkToGroup(
        tRDataset,
        groupId,
        addChunkToGroupData,
        options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.addChunkToGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async addChunkToGroupByTrackingId(
      tRDataset: string,
      trackingId: string,
      addChunkToGroupData: AddChunkToGroupData,
      options?: RawAxiosRequestConfig,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.addChunkToGroupByTrackingId(
          tRDataset,
          trackingId,
          addChunkToGroupData,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.addChunkToGroupByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async createChunkGroup(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChunkGroup>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createChunkGroup(
          tRDataset,
          createChunkGroupData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.createChunkGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteChunkGroup(
          tRDataset,
          groupId,
          deleteChunks,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.deleteChunkGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteGroupByTrackingId(
          tRDataset,
          trackingId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.deleteGroupByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getChunkGroup(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChunkGroup>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getChunkGroup(
        tRDataset,
        groupId,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.getChunkGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getChunksInGroup(
      tRDataset: string,
      groupId: string,
      page: number | null,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<BookmarkData>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getChunksInGroup(
          tRDataset,
          groupId,
          page,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.getChunksInGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getChunksInGroupByTrackingId(
      tRDataset: string,
      groupTrackingId: string,
      page: number,
      options?: RawAxiosRequestConfig,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getChunksInGroupByTrackingId(
          tRDataset,
          groupTrackingId,
          page,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.getChunksInGroupByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getGroupByTrackingId(
          tRDataset,
          trackingId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.getGroupByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getGroupsChunkIsIn(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<BookmarkGroupResult>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getGroupsChunkIsIn(
          tRDataset,
          getGroupsForChunksData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.getGroupsChunkIsIn"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getRecommendedGroups(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RecommendGroupChunkResponseTypes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getRecommendedGroups(
          tRDataset,
          reccomendGroupChunksRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.getRecommendedGroups"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getSpecificDatasetChunkGroups(
      tRDataset: string,
      datasetId: string,
      page: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GroupData>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getSpecificDatasetChunkGroups(
          tRDataset,
          datasetId,
          page,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.getSpecificDatasetChunkGroups"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.removeChunkFromGroup(
          tRDataset,
          groupId,
          createChunkGroupData,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.removeChunkFromGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async searchOverGroups(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SearchOverGroupsResponseTypes>
    > {
      const localVarAxiosArgs =
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.searchOverGroups"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async searchWithinGroup(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SearchWithinGroupResponseTypes>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.searchWithinGroup(
          tRDataset,
          searchWithinGroupData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.searchWithinGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateChunkGroup(
          tRDataset,
          updateChunkGroupData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.updateChunkGroup"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateGroupByTrackingId(
          tRDataset,
          trackingId,
          updateGroupByTrackingIDData,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ChunkGroupApi.updateGroupByTrackingId"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const ChunkGroupApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    addChunkToGroup(
      ...
      return localVarFp
        .addChunkToGroup(tRDataset, groupId, addChunkToGroupData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Add Chunk to Group by Tracking ID  Route to add a chunk to a group by tracking id.
    ...
    createChunkGroup(
      ...
      createChunkGroupData: CreateChunkGroupData,
      options?: any,
    ): AxiosPromise<ChunkGroup> {
      return localVarFp
        .createChunkGroup(tRDataset, createChunkGroupData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete Group  This will delete a chunk_group. This will not delete the chunks that are in the group. We will soon support deleting a chunk_group along with its member chunks.
    ...
    deleteChunkGroup(
      ...
      return localVarFp
        .deleteChunkGroup(tRDataset, groupId, deleteChunks, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete Group by Tracking ID  Delete a chunk_group with the given tracking id.
    ...
    deleteGroupByTrackingId(
      ...
      return localVarFp
        .deleteGroupByTrackingId(tRDataset, trackingId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Group  Fetch the group with the given id. get_group
    ...
    getChunkGroup(
      ...
      return localVarFp
        .getChunkGroup(tRDataset, groupId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Chunks in Group  Route to get all chunks for a group. The response is paginated, with each page containing 10 chunks. Support for custom page size is coming soon.
    ...
    getChunksInGroup(
      ...
      page: number | null,
      options?: any,
    ): AxiosPromise<BookmarkData> {
      return localVarFp
        .getChunksInGroup(tRDataset, groupId, page, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Chunks in Group by Tracking ID  Route to get all chunks for a group. The response is paginated, with each page containing 10 chunks. Support for custom page size is coming soon.
    ...
    getChunksInGroupByTrackingId(
      ...
      return localVarFp
        .getChunksInGroupByTrackingId(tRDataset, groupTrackingId, page, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Group by Tracking ID  Fetch the group with the given tracking id. get_group_by_tracking_id
    ...
    getGroupByTrackingId(
      ...
      return localVarFp
        .getGroupByTrackingId(tRDataset, trackingId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Groups for Chunks  Route to get the groups that a chunk is in.
    ...
    getGroupsChunkIsIn(
      ...
      return localVarFp
        .getGroupsChunkIsIn(tRDataset, getGroupsForChunksData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Recommended Groups  Route to get recommended groups. This route will return groups which are similar to the groups in the request body.
    ...
    getRecommendedGroups(
      ...
      return localVarFp
        .getRecommendedGroups(tRDataset, reccomendGroupChunksRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Groups for Dataset  Fetch the groups which belong to a dataset specified by its id.
    ...
    getSpecificDatasetChunkGroups(
      ...
      page: number,
      options?: any,
    ): AxiosPromise<GroupData> {
      return localVarFp
        .getSpecificDatasetChunkGroups(tRDataset, datasetId, page, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Remove Chunk from Group  Route to remove a chunk from a group.
    ...
    removeChunkFromGroup(
      ...
      return localVarFp
        .removeChunkFromGroup(tRDataset, groupId, createChunkGroupData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Search Over Groups  This route allows you to get groups as results instead of chunks. Each group returned will have the matching chunks sorted by similarity within the group. This is useful for when you want to get groups of chunks which are similar to the search query. If choosing hybrid search, the results will be re-ranked using BAAI/bge-reranker-large. Compatible with semantic, fulltext, or hybrid search modes.
    ...
    searchWithinGroup(
      ...
      return localVarFp
        .searchWithinGroup(tRDataset, searchWithinGroupData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update Group  Update a chunk_group. If you try to change the tracking_id to one that already exists, this operation will fail.
    ...
    updateChunkGroup(
      ...
      return localVarFp
        .updateChunkGroup(tRDataset, updateChunkGroupData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update Group by Tracking ID  Update a chunk_group with the given tracking id.
...
export class ChunkGroupApi extends BaseAPI {
   ...
   * @memberof ChunkGroupApi
   */
  public addChunkToGroupByTrackingId(
    tRDataset: string,
    trackingId: string,
    addChunkToGroupData: AddChunkToGroupData,
    options?: RawAxiosRequestConfig,
   ...
   * @memberof ChunkGroupApi
   */
  public deleteGroupByTrackingId(
    tRDataset: string,
    trackingId: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof ChunkGroupApi
   */
  public getChunksInGroupByTrackingId(
    tRDataset: string,
    groupTrackingId: string,
    page: number,
    options?: RawAxiosRequestConfig,
   ...
   * @memberof ChunkGroupApi
   */
  public getSpecificDatasetChunkGroups(
    tRDataset: string,
    datasetId: string,
    page: number,
    options?: RawAxiosRequestConfig,
   ...
   * @memberof ChunkGroupApi
   */
  public updateGroupByTrackingId(
    tRDataset: string,
    trackingId: string,
    updateGroupByTrackingIDData: UpdateGroupByTrackingIDData,
    options?: RawAxiosRequestConfig,
...
export const DatasetApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {string} tROrganization The organization id to use for the request
     * @param {DeleteDatasetRequest} deleteDatasetRequest JSON request payload to delete a dataset
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    deleteDataset: async (
      ...
      // verify required parameter 'tROrganization' is not null or undefined
      assertParamExists("deleteDataset", "tROrganization", tROrganization);
    ...
    getDataset: async (
      ...
      const localVarPath = `/api/dataset/{dataset_id}`.replace(
        `{${"dataset_id"}}`,
     ...
     * @throws {RequiredError}
     */
    getDatasetsFromOrganization: async (
      tROrganization: string,
      ...
      const localVarPath =
        `/api/dataset/organization/{organization_id}`.replace(
          `{${"organization_id"}}`,
...
export const DatasetApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetApi.createDataset"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetApi.deleteDataset"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getClientDatasetConfig(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ClientDatasetConfiguration>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getClientDatasetConfig(
          tRDataset,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetApi.getClientDatasetConfig"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getDataset(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dataset>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDataset(
        tROrganization,
        tRDataset,
        datasetId,
        options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetApi.getDataset"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getDatasetsFromOrganization(
      tROrganization: string,
      organizationId: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<DatasetAndUsage>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getDatasetsFromOrganization(
          tROrganization,
          organizationId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetApi.getDatasetsFromOrganization"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async updateDataset(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dataset>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateDataset(
        tROrganization,
        updateDatasetRequest,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetApi.updateDataset"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const DatasetApiFactory = function (
  ...
  return {
    ...
    createDataset(
      ...
      return localVarFp
        .createDataset(tROrganization, createDatasetRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete Dataset  Delete a dataset. The auth\'ed user must be an owner of the organization to delete a dataset.
    ...
    deleteDataset(
      ...
      return localVarFp
        .deleteDataset(tROrganization, deleteDatasetRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Client Configuration  Get the client configuration for a dataset. Will use the TR-D
    ...
    getClientDatasetConfig(
      ...
      return localVarFp
        .getClientDatasetConfig(tRDataset, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Dataset  Get a dataset by id. The auth\'ed user must be an admin or owner of the organization to get a dataset.
    ...
    getDataset(
      ...
      return localVarFp
        .getDataset(tROrganization, tRDataset, datasetId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Datasets from Organization  Get all datasets for an organization. The auth\'ed user must be an admin or owner of the organization to get its datasets.
    ...
    getDatasetsFromOrganization(
      ...
      return localVarFp
        .getDatasetsFromOrganization(tROrganization, organizationId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update Dataset  Update a dataset. The auth\'ed user must be an owner of the organization to update a dataset.
    ...
    updateDataset(
      ...
      return localVarFp
        .updateDataset(tROrganization, updateDatasetRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class DatasetApi extends BaseAPI {
   ...
   * @memberof DatasetApi
   */
  public getDatasetsFromOrganization(
    tROrganization: string,
    organizationId: string,
    options?: RawAxiosRequestConfig,
  ) {
...
export const EventsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getEvents(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventReturn>
    > {
...
export const EventsApiFactory = function (
  ...
  return {
    ...
    getEvents(
      ...
      getEventsData: GetEventsData,
      options?: any,
    ): AxiosPromise<EventReturn> {
      return localVarFp
        .getEvents(tRDataset, getEventsData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const FileApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteFileHandler: async (
      ...
      const localVarPath = `/api/file/{file_id}`.replace(
        `{${"file_id"}}`,
...
export const FileApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteFileHandler(
          tRDataset,
          fileId,
          deleteChunks,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["FileApi.deleteFileHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getDatasetFilesHandler(
          tRDataset,
          datasetId,
          page,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["FileApi.getDatasetFilesHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getFileHandler(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileDTO>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getFileHandler(
        tRDataset,
        fileId,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["FileApi.getFileHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async uploadFileHandler(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UploadFileResult>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.uploadFileHandler(
          tRDataset,
          uploadFileData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["FileApi.uploadFileHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const FileApiFactory = function (
  ...
  return {
    ...
    deleteFileHandler(
      ...
      return localVarFp
        .deleteFileHandler(tRDataset, fileId, deleteChunks, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Files for Dataset  Get all files which belong to a given dataset specified by the dataset_id parameter. 10 files are returned per page.
    ...
    getDatasetFilesHandler(
      ...
      return localVarFp
        .getDatasetFilesHandler(tRDataset, datasetId, page, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get File  Download a file from S3 attached to the server based on its id. We plan to add support for getting signed S3 URLs to download from S3 directly in a release soon.
    ...
    getFileHandler(
      ...
      return localVarFp
        .getFileHandler(tRDataset, fileId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Upload File  Upload a file to S3 attached to the server. The file will be converted to HTML with tika and chunked algorithmically, images will be OCR\'ed with tesseract. The resulting chunks will be indexed and searchable. Optionally, you can only upload the file and manually create chunks associated to the file after. See docs.trieve.ai and/or contact us for more details and tips. Auth\'ed user must be an admin or owner of the dataset\'s organization to upload a file.
    ...
    uploadFileHandler(
      ...
      return localVarFp
        .uploadFileHandler(tRDataset, uploadFileData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const InvitationApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async postInvitation(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postInvitation(
        tROrganization,
        invitationData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["InvitationApi.postInvitation"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const InvitationApiFactory = function (
  ...
  return {
    ...
    postInvitation(
      ...
      return localVarFp
        .postInvitation(tROrganization, invitationData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const MessageApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createMessageCompletionHandler: async (
      tRDataset: string,
    ...
    getAllTopicMessages: async (
      ...
      const localVarPath = `/api/messages/{messages_topic_id}`.replace(
        `{${"messages_topic_id"}}`,
        encodeURIComponent(String(messagesTopicId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @throws {RequiredError}
     */
    regenerateMessageHandler: async (
      tRDataset: string,
...
export const MessageApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createMessageCompletionHandler(
      tRDataset: string,
      createMessageData: CreateMessageData,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createMessageCompletionHandler(
          tRDataset,
          createMessageData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MessageApi.createMessageCompletionHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.editMessageHandler(
          tRDataset,
          editMessageData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MessageApi.editMessageHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllTopicMessages(
          tRDataset,
          messagesTopicId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MessageApi.getAllTopicMessages"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async regenerateMessageHandler(
      tRDataset: string,
      regenerateMessageData: RegenerateMessageData,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.regenerateMessageHandler(
          tRDataset,
          regenerateMessageData,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MessageApi.regenerateMessageHandler"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const MessageApiFactory = function (
  ...
  return {
    ...
    createMessageCompletionHandler(
      ...
      return localVarFp
        .createMessageCompletionHandler(tRDataset, createMessageData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Edit a message  Edit a message which exists within the topic\'s chat history. This will delete the message and replace it with a new message. The new message will be generated by the AI based on the new content provided in the request body. The response will include Chunks first on the stream if the topic is using RAG. The structure will look like `[chunks]||mesage`. See docs.trieve.ai for more information.
    ...
    editMessageHandler(
      ...
      return localVarFp
        .editMessageHandler(tRDataset, editMessageData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get all messages for a given topic  Get all messages for a given topic. If the topic is a RAG topic then the response will include Chunks first on each message. The structure will look like `[chunks]||mesage`. See docs.trieve.ai for more information.
    ...
    getAllTopicMessages(
      ...
      return localVarFp
        .getAllTopicMessages(tRDataset, messagesTopicId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Regenerate message  Regenerate the assistant response to the last user message of a topic. This will delete the last message and replace it with a new message. The response will include Chunks first on the stream if the topic is using RAG. The structure will look like `[chunks]||mesage`. See docs.trieve.ai for more information.
    ...
    regenerateMessageHandler(
      ...
      return localVarFp
        .regenerateMessageHandler(tRDataset, regenerateMessageData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class MessageApi extends BaseAPI {
   ...
   * @memberof MessageApi
   */
  public createMessageCompletionHandler(
    tRDataset: string,
    createMessageData: CreateMessageData,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof MessageApi
   */
  public regenerateMessageHandler(
    tRDataset: string,
    regenerateMessageData: RegenerateMessageData,
    options?: RawAxiosRequestConfig,
  ) {
...
export const OrganizationApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteOrganizationById: async (
      ...
      const localVarPath = `/api/organization/{organization_id}`.replace(
        `{${"organization_id"}}`,
        encodeURIComponent(String(organizationId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getOrganizationUsage: async (
      ...
      const localVarPath = `/api/organization/usage/{organization_id}`.replace(
        `{${"organization_id"}}`,
        encodeURIComponent(String(organizationId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getOrganizationUsers: async (
      ...
      const localVarPath = `/api/organization/users/{organization_id}`.replace(
        `{${"organization_id"}}`,
        encodeURIComponent(String(organizationId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const OrganizationApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteOrganizationById(
          tROrganization,
          organizationId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationApi.deleteOrganizationById"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getOrganizationById(
          tROrganization,
          organizationId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationApi.getOrganizationById"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getOrganizationUsage(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<OrganizationUsageCount>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getOrganizationUsage(
          tROrganization,
          organizationId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationApi.getOrganizationUsage"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getOrganizationUsers(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<SlimUser>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getOrganizationUsers(
          tROrganization,
          organizationId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationApi.getOrganizationUsers"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationApi.updateOrganization"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const OrganizationApiFactory = function (
  ...
  return {
    ...
    createOrganization(
      ...
      return localVarFp
        .createOrganization(createOrganizationData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete Organization  Delete an organization by its id. The auth\'ed user must be an owner of the organization to delete it.
    ...
    deleteOrganizationById(
      ...
      return localVarFp
        .deleteOrganizationById(tROrganization, organizationId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Organization  Fetch the details of an organization by its id. The auth\'ed user must be an admin or owner of the organization to fetch it.
    ...
    getOrganizationById(
      ...
      return localVarFp
        .getOrganizationById(tROrganization, organizationId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Organization Usage  Fetch the current usage specification of an organization by its id. The auth\'ed user must be an admin or owner of the organization to fetch it.
    ...
    getOrganizationUsage(
      ...
      return localVarFp
        .getOrganizationUsage(tROrganization, organizationId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get Organization Users  Fetch the users of an organization by its id. The auth\'ed user must be an admin or owner of the organization to fetch it.
    ...
    getOrganizationUsers(
      ...
      return localVarFp
        .getOrganizationUsers(tROrganization, organizationId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update Organization  Update an organization. Only the owner of the organization can update it.
    ...
    updateOrganization(
      ...
      return localVarFp
        .updateOrganization(tROrganization, updateOrganizationData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const StripeApiAxiosParamCreator = function (
  ...
  return {
    ...
    cancelSubscription: async (
      ...
      const localVarPath = `/api/stripe/subscription/{subscription_id}`.replace(
        `{${"subscription_id"}}`,
...
export const StripeApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StripeApi.cancelSubscription"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.directToPaymentLink(
          planId,
          organizationId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StripeApi.directToPaymentLink"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getAllPlans(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<StripePlan>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllPlans(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StripeApi.getAllPlans"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateSubscriptionPlan(
          tROrganization,
          subscriptionId,
          planId,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StripeApi.updateSubscriptionPlan"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const StripeApiFactory = function (
  ...
  return {
    ...
    cancelSubscription(
      ...
      return localVarFp
        .cancelSubscription(tROrganization, subscriptionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Checkout  Get a direct link to the stripe checkout page for the plan and organization
    ...
    directToPaymentLink(
      ...
      return localVarFp
        .directToPaymentLink(planId, organizationId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get All Plans  Get a list of all plans
    ...
    updateSubscriptionPlan(
      ...
      return localVarFp
        .updateSubscriptionPlan(tROrganization, subscriptionId, planId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
 ...
 * @export
 */
export const TopicApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @param {string} tRDataset The dataset id to use for the request
     * @param {DeleteTopicData} deleteTopicData JSON request payload to delete a chat topic
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    deleteTopic: async (
      ...
      assertParamExists("deleteTopic", "deleteTopicData", deleteTopicData);
      const localVarPath = `/api/topic`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    getAllTopicsForUser: async (
      ...
      const localVarPath = `/api/topic/user/{user_id}`.replace(
        `{${"user_id"}}`,
...
export const TopicApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createTopic(
        tRDataset,
        createTopicData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TopicApi.createTopic"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async deleteTopic(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteTopic(
        tRDataset,
        deleteTopicData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TopicApi.deleteTopic"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getAllTopicsForUser(
      userId: string,
      tRDataset: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Topic>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllTopicsForUser(
          userId,
          tRDataset,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TopicApi.getAllTopicsForUser"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async updateTopic(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateTopic(
        tRDataset,
        updateTopicData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TopicApi.updateTopic"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const TopicApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    createTopic(
      ...
      return localVarFp
        .createTopic(tRDataset, createTopicData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete Topic  Delete an existing chat topic. When a topic is deleted, all associated chat messages are also deleted.
    ...
    deleteTopic(
      ...
      return localVarFp
        .deleteTopic(tRDataset, deleteTopicData, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get All Topics for User  Get all topics belonging to a the auth\'ed user. Soon, we plan to allow specification of the user for this route and include pagination.
    ...
    getAllTopicsForUser(
      ...
      return localVarFp
        .getAllTopicsForUser(userId, tRDataset, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update Topic  Update an existing chat topic. Currently, only the name of the topic can be updated.
    ...
    updateTopic(
      ...
      return localVarFp
        .updateTopic(tRDataset, updateTopicData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class TopicApi extends BaseAPI {
  ...
  public createTopic(
    ...
    return TopicApiFp(this.configuration)
      .createTopic(tRDataset, createTopicData, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const UserApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {DeleteUserApiKeyRequest} deleteUserApiKeyRequest JSON request payload to delete a user api key
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
  ...
  return {
    ...
    async deleteUserApiKey(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ApiKeyDTO>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteUserApiKey(
          deleteUserApiKeyRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["UserApi.deleteUserApiKey"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async setUserApiKey(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SetUserApiKeyResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.setUserApiKey(
        setUserApiKeyRequest,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["UserApi.setUserApiKey"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const UserApiFactory = function (
  ...
  return {
    ...
    deleteUserApiKey(
      ...
      return localVarFp
        .deleteUserApiKey(deleteUserApiKeyRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Set User Api Key  Create a new api key for the auth\'ed user. Successful response will contain the newly created api key. If a write role is assigned the api key will have permission level of the auth\'ed user who calls this endpoint.
    ...
    setUserApiKey(
      ...
      return localVarFp
        .setUserApiKey(setUserApiKeyRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update User  Update a user\'s information. If the user_id is not provided, the auth\'ed user will be updated. If the user_id is provided, the auth\'ed user must be an admin (1) or owner (2) of the organization.
    ...
    updateUser(
      updateUserData: UpdateUserData,
      options?: any,
    ): AxiosPromise<SlimUser> {
      return localVarFp
        .updateUser(updateUserData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
