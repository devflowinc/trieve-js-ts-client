 ...
 * @export
 */
export type RAGAnalytics = RAGQueries | RAGUsage | RAGUsageGraph;
 ...
 * @export
 */
export type RAGAnalyticsResponse = RAGUsageGraphResponse | RAGUsageResponse | RagQueryResponse;
 ...
 * @export
 */
export type RecommendationAnalytics = LowConfidenceRecommendations | RecommendationQueries;
 ...
 * @export
 */
export type SearchAnalytics = CountQueries | HeadQueries1 | LatencyGraph | LowConfidenceQueries | NoResultQueries | QueryDetails | SearchMetrics | SearchQueries | SearchUsageGraph;
 ...
 * @export
 */
export type SearchAnalyticsResponse = DatasetAnalytics | HeadQueryResponse | LatencyGraphResponse | QueryCountResponse | SearchQueryEvent | SearchQueryResponse | SearchUsageGraphResponse;
...
export const AnalyticsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getRecommendationAnalytics: async (tRDataset: string, recommendationAnalytics: RecommendationAnalytics, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/analytics/recommendation`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @summary Rate Query
         * @param {string} tRDataset The dataset id or tracking_id to use for the request. We assume you intend to use an id if the value is a valid uuid.
         * @param {RateQueryRequest} rateQueryRequest JSON request payload to rate a query
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        setQueryRating: async (tRDataset: string, rateQueryRequest: RateQueryRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
            assertParamExists('setQueryRating', 'tRDataset', tRDataset)
            // verify required parameter 'rateQueryRequest' is not null or undefined
            assertParamExists('setQueryRating', 'rateQueryRequest', rateQueryRequest)
            const localVarPath = `/api/analytics/search`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const AnalyticsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async setQueryRating(tRDataset: string, rateQueryRequest: RateQueryRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.setQueryRating(tRDataset, rateQueryRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AnalyticsApi.setQueryRating']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const AnalyticsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        setQueryRating(tRDataset: string, rateQueryRequest: RateQueryRequest, options?: any): AxiosPromise<void> {
            return localVarFp.setQueryRating(tRDataset, rateQueryRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AnalyticsApi extends BaseAPI {
     ...
     * @memberof AnalyticsApi
     */
    public setQueryRating(tRDataset: string, rateQueryRequest: RateQueryRequest, options?: RawAxiosRequestConfig) {
        return AnalyticsApiFp(this.configuration).setQueryRating(tRDataset, rateQueryRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const ChunkApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} tRDataset The dataset id or tracking_id to use for the request. We assume you intend to use an id if the value is a valid uuid.
         * @param {ScrollChunksReqPayload} scrollChunksReqPayload 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const ChunkApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async scrollDatasetChunks(tRDataset: string, scrollChunksReqPayload: ScrollChunksReqPayload, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ScrollChunksReqPayload>> {
...
export const ChunkApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        scrollDatasetChunks(tRDataset: string, scrollChunksReqPayload: ScrollChunksReqPayload, options?: any): AxiosPromise<ScrollChunksReqPayload> {
...
export const OrganizationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrganization(tROrganization: string, organizationId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Organization>> {
...
export const OrganizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getOrganization(tROrganization: string, organizationId: string, options?: any): AxiosPromise<Organization> {
