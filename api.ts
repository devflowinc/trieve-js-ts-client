 ...
 * @export
 * @interface ApiKeyRequestParams
 */
export interface ApiKeyRequestParams {
    /**
     * 
     * @type {ChunkFilter}
     * @memberof ApiKeyRequestParams
     */
 ...
 * 
 * @export
 * @interface ChunkHtmlContentReqPayload
 */
export interface ChunkHtmlContentReqPayload {
    /**
     * Text strings to remove from body when creating chunks for each page
     * @type {Array<string>}
     * @memberof ChunkHtmlContentReqPayload
     */
 ...
 * 
 * @export
 * @interface CreateApiKeyReqPayload
 */
export interface CreateApiKeyReqPayload {
    /**
     ...
     * @type {Array<string>}
     * @memberof CreateApiKeyReqPayload
     */
    'dataset_ids'?: Array<string> | null;
    /**
     * 
 ...
 * 
 * @export
 * @interface CreateBatchDataset
 */
export interface CreateBatchDataset {
    /**
     * Name of the dataset.
     * @type {string}
     * @memberof CreateBatchDataset
     */
    'dataset_name': string;
    /**
     * 
 ...
 * 
 * @export
 * @interface CreateDatasetBatchReqPayload
 */
export interface CreateDatasetBatchReqPayload {
    /**
     * List of datasets to create
     * @type {Array<CreateBatchDataset>}
     * @memberof CreateDatasetBatchReqPayload
     */
 ...
 * 
 * @export
 * @interface CreateDatasetReqPayload
 */
export interface CreateDatasetReqPayload {
    /**
     * 
     * @type {CrawlOptions}
     * @memberof CreateDatasetReqPayload
     */
 ...
 * 
 * @export
 * @interface GetChunkGroupCountRequest
 */
export interface GetChunkGroupCountRequest {
    /**
     * The Id of the group to get the count for, is not required if group_tracking_id is provided.
     * @type {string}
     * @memberof GetChunkGroupCountRequest
     */
 ...
 * 
 * @export
 * @interface GetChunkGroupCountResponse
 */
export interface GetChunkGroupCountResponse {
    /**
     * The count of chunks in the given group.
     * @type {number}
     * @memberof GetChunkGroupCountResponse
     */
    'count': number;
    /**
 ...
 * 
 * @export
 * @interface QdrantChunkMetadata
 */
export interface QdrantChunkMetadata {
    /**
     * 
     * @type {string}
     * @memberof QdrantChunkMetadata
     */
    'chunk_html'?: string | null;
    /**
     * 
 ...
 * 
 * @export
 * @interface SplitHtmlResponse
 */
export interface SplitHtmlResponse {
    /**
     * 
     * @type {Array<ChunkedContent>}
     * @memberof SplitHtmlResponse
     */
 ...
 * 
 * @export
 * @interface UpdateDatasetReqPayload
 */
export interface UpdateDatasetReqPayload {
    /**
     * 
     * @type {CrawlOptions}
     * @memberof UpdateDatasetReqPayload
     */
    'crawl_options'?: CrawlOptions | null;
    /**
 ...
 * 
 * @export
 * @interface UpdateUserOrgRoleReqPayload
 */
export interface UpdateUserOrgRoleReqPayload {
    /**
     ...
     * @type {number}
     * @memberof UpdateUserOrgRoleReqPayload
     */
    'role': number;
    /**
...
export const ChunkApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ChunkHtmlContentReqPayload} chunkHtmlContentReqPayload JSON request payload to perform RAG on some chunks (chunks)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        splitHtmlContent: async (chunkHtmlContentReqPayload: ChunkHtmlContentReqPayload, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'chunkHtmlContentReqPayload' is not null or undefined
            assertParamExists('splitHtmlContent', 'chunkHtmlContentReqPayload', chunkHtmlContentReqPayload)
            const localVarPath = `/api/chunk/split`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(chunkHtmlContentReqPayload, localVarRequestOptions, configuration)
...
export const ChunkApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async splitHtmlContent(chunkHtmlContentReqPayload: ChunkHtmlContentReqPayload, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SplitHtmlResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.splitHtmlContent(chunkHtmlContentReqPayload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ChunkApi.splitHtmlContent']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update a chunk. If you try to change the tracking_id of the chunk to have the same tracking_id as an existing chunk, the request will fail. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
...
export const ChunkApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        splitHtmlContent(chunkHtmlContentReqPayload: ChunkHtmlContentReqPayload, options?: any): AxiosPromise<SplitHtmlResponse> {
            return localVarFp.splitHtmlContent(chunkHtmlContentReqPayload, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a chunk. If you try to change the tracking_id of the chunk to have the same tracking_id as an existing chunk, the request will fail. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
         * @summary Update Chunk
...
export class ChunkApi extends BaseAPI {
     ...
     * @memberof ChunkApi
     */
    public splitHtmlContent(chunkHtmlContentReqPayload: ChunkHtmlContentReqPayload, options?: RawAxiosRequestConfig) {
        return ChunkApiFp(this.configuration).splitHtmlContent(chunkHtmlContentReqPayload, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ChunkGroupApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} tRDataset The dataset id or tracking_id to use for the request. We assume you intend to use an id if the value is a valid uuid.
         * @param {GetChunkGroupCountRequest} getChunkGroupCountRequest JSON request payload to add a chunk to a group (bookmark it)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        countGroupChunks: async (tRDataset: string, getChunkGroupCountRequest: GetChunkGroupCountRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
            assertParamExists('countGroupChunks', 'tRDataset', tRDataset)
            // verify required parameter 'getChunkGroupCountRequest' is not null or undefined
            assertParamExists('countGroupChunks', 'getChunkGroupCountRequest', getChunkGroupCountRequest)
            const localVarPath = `/api/chunk_group/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(getChunkGroupCountRequest, localVarRequestOptions, configuration)
...
export const ChunkGroupApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async countGroupChunks(tRDataset: string, getChunkGroupCountRequest: GetChunkGroupCountRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetChunkGroupCountResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.countGroupChunks(tRDataset, getChunkGroupCountRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ChunkGroupApi.countGroupChunks']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Create new chunk_group(s). This is a way to group chunks together. If you try to create a chunk_group with the same tracking_id as an existing chunk_group, this operation will fail. Only 1000 chunk groups can be created at a time. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
...
export const ChunkGroupApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        countGroupChunks(tRDataset: string, getChunkGroupCountRequest: GetChunkGroupCountRequest, options?: any): AxiosPromise<GetChunkGroupCountResponse> {
            return localVarFp.countGroupChunks(tRDataset, getChunkGroupCountRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Create new chunk_group(s). This is a way to group chunks together. If you try to create a chunk_group with the same tracking_id as an existing chunk_group, this operation will fail. Only 1000 chunk groups can be created at a time. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
         * @summary Create or Upsert Group or Groups
...
export class ChunkGroupApi extends BaseAPI {
     ...
     * @memberof ChunkGroupApi
     */
    public countGroupChunks(tRDataset: string, getChunkGroupCountRequest: GetChunkGroupCountRequest, options?: RawAxiosRequestConfig) {
        return ChunkGroupApiFp(this.configuration).countGroupChunks(tRDataset, getChunkGroupCountRequest, options).then((request) => request(this.axios, this.basePath));
    }
...
export const DatasetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} tROrganization The organization id to use for the request
         * @param {CreateDatasetBatchReqPayload} createDatasetBatchReqPayload JSON request payload to bulk create datasets
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        batchCreateDatasets: async (tROrganization: string, createDatasetBatchReqPayload: CreateDatasetBatchReqPayload, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tROrganization' is not null or undefined
            assertParamExists('batchCreateDatasets', 'tROrganization', tROrganization)
            // verify required parameter 'createDatasetBatchReqPayload' is not null or undefined
            assertParamExists('batchCreateDatasets', 'createDatasetBatchReqPayload', createDatasetBatchReqPayload)
            const localVarPath = `/api/dataset/batch_create_datasets`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createDatasetBatchReqPayload, localVarRequestOptions, configuration)
         ...
         * @param {string} tROrganization The organization id to use for the request
         * @param {CreateDatasetReqPayload} createDatasetReqPayload JSON request payload to create a new dataset
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createDataset: async (tROrganization: string, createDatasetReqPayload: CreateDatasetReqPayload, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tROrganization' is not null or undefined
            assertParamExists('createDataset', 'tROrganization', tROrganization)
            // verify required parameter 'createDatasetReqPayload' is not null or undefined
            assertParamExists('createDataset', 'createDatasetReqPayload', createDatasetReqPayload)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createDatasetReqPayload, localVarRequestOptions, configuration)
         ...
         * @param {string} tROrganization The organization id to use for the request
         * @param {UpdateDatasetReqPayload} updateDatasetReqPayload JSON request payload to update a dataset
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateDataset: async (tROrganization: string, updateDatasetReqPayload: UpdateDatasetReqPayload, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tROrganization' is not null or undefined
            assertParamExists('updateDataset', 'tROrganization', tROrganization)
            // verify required parameter 'updateDatasetReqPayload' is not null or undefined
            assertParamExists('updateDataset', 'updateDatasetReqPayload', updateDatasetReqPayload)
            const localVarPath = `/api/dataset`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(updateDatasetReqPayload, localVarRequestOptions, configuration)
...
export const DatasetApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async batchCreateDatasets(tROrganization: string, createDatasetBatchReqPayload: CreateDatasetBatchReqPayload, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Dataset>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.batchCreateDatasets(tROrganization, createDatasetBatchReqPayload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DatasetApi.batchCreateDatasets']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Removes all chunks, files, and groups from the dataset while retaining the analytics and dataset itself. The auth\'ed user must be an owner of the organization to clear a dataset.
         ...
         * @throws {RequiredError}
         */
        async createDataset(tROrganization: string, createDatasetReqPayload: CreateDatasetReqPayload, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dataset>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createDataset(tROrganization, createDatasetReqPayload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateDataset(tROrganization: string, updateDatasetReqPayload: UpdateDatasetReqPayload, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dataset>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateDataset(tROrganization, updateDatasetReqPayload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DatasetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        batchCreateDatasets(tROrganization: string, createDatasetBatchReqPayload: CreateDatasetBatchReqPayload, options?: any): AxiosPromise<Array<Dataset>> {
            return localVarFp.batchCreateDatasets(tROrganization, createDatasetBatchReqPayload, options).then((request) => request(axios, basePath));
        },
        /**
         * Removes all chunks, files, and groups from the dataset while retaining the analytics and dataset itself. The auth\'ed user must be an owner of the organization to clear a dataset.
         * @summary Clear Dataset
         ...
         * @throws {RequiredError}
         */
        createDataset(tROrganization: string, createDatasetReqPayload: CreateDatasetReqPayload, options?: any): AxiosPromise<Dataset> {
            return localVarFp.createDataset(tROrganization, createDatasetReqPayload, options).then((request) => request(axios, basePath));
        },
        /**
         * Auth\'ed user must be an owner of the organization to delete a dataset.
         * @summary Delete Dataset
         ...
         * @throws {RequiredError}
         */
        updateDataset(tROrganization: string, updateDatasetReqPayload: UpdateDatasetReqPayload, options?: any): AxiosPromise<Dataset> {
            return localVarFp.updateDataset(tROrganization, updateDatasetReqPayload, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DatasetApi extends BaseAPI {
     ...
     * @memberof DatasetApi
     */
    public batchCreateDatasets(tROrganization: string, createDatasetBatchReqPayload: CreateDatasetBatchReqPayload, options?: RawAxiosRequestConfig) {
        return DatasetApiFp(this.configuration).batchCreateDatasets(tROrganization, createDatasetBatchReqPayload, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatasetApi
     */
    public createDataset(tROrganization: string, createDatasetReqPayload: CreateDatasetReqPayload, options?: RawAxiosRequestConfig) {
        return DatasetApiFp(this.configuration).createDataset(tROrganization, createDatasetReqPayload, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatasetApi
     */
    public updateDataset(tROrganization: string, updateDatasetReqPayload: UpdateDatasetReqPayload, options?: RawAxiosRequestConfig) {
        return DatasetApiFp(this.configuration).updateDataset(tROrganization, updateDatasetReqPayload, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const MessageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getMessageById: async (tRDataset: string, messageId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
            assertParamExists('getMessageById', 'tRDataset', tRDataset)
...
export const MessageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMessageById(tRDataset: string, messageId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Message>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMessageById(tRDataset, messageId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const MessageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getMessageById(tRDataset: string, messageId: string, options?: any): AxiosPromise<Message> {
            return localVarFp.getMessageById(tRDataset, messageId, options).then((request) => request(axios, basePath));
        },
        /**
         * Regenerate the assistant response to the last user message of a topic. This will delete the last message and replace it with a new message. The response will include Chunks first on the stream if the topic is using RAG. The structure will look like `[chunks]||mesage`. See docs.trieve.ai for more information. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
         * @summary Regenerate message
...
export class MessageApi extends BaseAPI {
     ...
     * @memberof MessageApi
     */
    public getMessageById(tRDataset: string, messageId: string, options?: RawAxiosRequestConfig) {
        return MessageApiFp(this.configuration).getMessageById(tRDataset, messageId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const OrganizationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} tROrganization The organization id to use for the request.
         * @param {CreateApiKeyReqPayload} createApiKeyReqPayload JSON request payload to create a new organization api key
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createOrganizationApiKey: async (tROrganization: string, createApiKeyReqPayload: CreateApiKeyReqPayload, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tROrganization' is not null or undefined
            assertParamExists('createOrganizationApiKey', 'tROrganization', tROrganization)
            // verify required parameter 'createApiKeyReqPayload' is not null or undefined
            assertParamExists('createOrganizationApiKey', 'createApiKeyReqPayload', createApiKeyReqPayload)
            const localVarPath = `/api/organization/api_key`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createApiKeyReqPayload, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteOrganizationApiKey: async (apiKeyId: string, tROrganization: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'apiKeyId' is not null or undefined
            assertParamExists('deleteOrganizationApiKey', 'apiKeyId', apiKeyId)
            // verify required parameter 'tROrganization' is not null or undefined
            assertParamExists('deleteOrganizationApiKey', 'tROrganization', tROrganization)
            const localVarPath = `/api/organization/api_key/{api_key_id}`
         ...
         * @throws {RequiredError}
         */
        getOrganizationApiKeys: async (tROrganization: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tROrganization' is not null or undefined
            assertParamExists('getOrganizationApiKeys', 'tROrganization', tROrganization)
            const localVarPath = `/api/organization/api_key`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const OrganizationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createOrganizationApiKey(tROrganization: string, createApiKeyReqPayload: CreateApiKeyReqPayload, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateApiKeyResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createOrganizationApiKey(tROrganization, createApiKeyReqPayload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationApi.createOrganizationApiKey']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Delete an organization by its id. The auth\'ed user must be an owner of the organization to delete it.
         ...
         * @throws {RequiredError}
         */
        async deleteOrganizationApiKey(apiKeyId: string, tROrganization: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteOrganizationApiKey(apiKeyId, tROrganization, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationApi.deleteOrganizationApiKey']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetch the details of an organization by its id. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
         ...
         * @throws {RequiredError}
         */
        async getOrganizationApiKeys(tROrganization: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ApiKeyRespBody>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getOrganizationApiKeys(tROrganization, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationApi.getOrganizationApiKeys']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetch the current usage specification of an organization by its id. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
...
export const OrganizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createOrganizationApiKey(tROrganization: string, createApiKeyReqPayload: CreateApiKeyReqPayload, options?: any): AxiosPromise<CreateApiKeyResponse> {
            return localVarFp.createOrganizationApiKey(tROrganization, createApiKeyReqPayload, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete an organization by its id. The auth\'ed user must be an owner of the organization to delete it.
         * @summary Delete Organization
         ...
         * @throws {RequiredError}
         */
        deleteOrganizationApiKey(apiKeyId: string, tROrganization: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteOrganizationApiKey(apiKeyId, tROrganization, options).then((request) => request(axios, basePath));
        },
        /**
         * Fetch the details of an organization by its id. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
         * @summary Get Organization
         ...
         * @throws {RequiredError}
         */
        getOrganizationApiKeys(tROrganization: string, options?: any): AxiosPromise<Array<ApiKeyRespBody>> {
            return localVarFp.getOrganizationApiKeys(tROrganization, options).then((request) => request(axios, basePath));
        },
        /**
         * Fetch the current usage specification of an organization by its id. Auth\'ed user or api key must have an admin or owner role for the specified dataset\'s organization.
         * @summary Get Organization Usage
...
export class OrganizationApi extends BaseAPI {
     ...
     * @memberof OrganizationApi
     */
    public createOrganizationApiKey(tROrganization: string, createApiKeyReqPayload: CreateApiKeyReqPayload, options?: RawAxiosRequestConfig) {
        return OrganizationApiFp(this.configuration).createOrganizationApiKey(tROrganization, createApiKeyReqPayload, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrganizationApi
     */
    public deleteOrganizationApiKey(apiKeyId: string, tROrganization: string, options?: RawAxiosRequestConfig) {
        return OrganizationApiFp(this.configuration).deleteOrganizationApiKey(apiKeyId, tROrganization, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrganizationApi
     */
    public getOrganizationApiKeys(tROrganization: string, options?: RawAxiosRequestConfig) {
        return OrganizationApiFp(this.configuration).getOrganizationApiKeys(tROrganization, options).then((request) => request(this.axios, this.basePath));
    }
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} tROrganization The organization id to use for the request
         * @param {UpdateUserOrgRoleReqPayload} updateUserOrgRoleReqPayload JSON request payload to update user information for the auth\&#39;ed user
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateUser: async (tROrganization: string, updateUserOrgRoleReqPayload: UpdateUserOrgRoleReqPayload, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tROrganization' is not null or undefined
            assertParamExists('updateUser', 'tROrganization', tROrganization)
            // verify required parameter 'updateUserOrgRoleReqPayload' is not null or undefined
            assertParamExists('updateUser', 'updateUserOrgRoleReqPayload', updateUserOrgRoleReqPayload)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(updateUserOrgRoleReqPayload, localVarRequestOptions, configuration)
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateUser(tROrganization: string, updateUserOrgRoleReqPayload: UpdateUserOrgRoleReqPayload, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateUser(tROrganization, updateUserOrgRoleReqPayload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateUser(tROrganization: string, updateUserOrgRoleReqPayload: UpdateUserOrgRoleReqPayload, options?: any): AxiosPromise<void> {
            return localVarFp.updateUser(tROrganization, updateUserOrgRoleReqPayload, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public updateUser(tROrganization: string, updateUserOrgRoleReqPayload: UpdateUserOrgRoleReqPayload, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).updateUser(tROrganization, updateUserOrgRoleReqPayload, options).then((request) => request(this.axios, this.basePath));
    }
}
