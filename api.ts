 ...
 * 
 * @export
 * @interface RecommendChunkMetadata
 */
export interface RecommendChunkMetadata extends Array<ChunkMetadata> {
}
/**
 * 
 * @export
 ...
 * @export
 */
export type RecommendChunksResponseTypes = RecommendChunkMetadata | RecommendSlimChunkMetadata;

/**
 * @type RecommendGroupChunkResponseTypes
 * @export
 */
export type RecommendGroupChunkResponseTypes = RecommendGroupChunksDTO | RecommendGroupSlimChunksDTO;

/**
 * 
 * @export
 * @interface RecommendGroupChunksDTO
 */
export interface RecommendGroupChunksDTO extends Array<GroupScoreChunkDTO> {
}
/**
 * 
 * @export
 ...
 * 
 * @export
 * @interface RecommendGroupSlimChunksDTO
 */
export interface RecommendGroupSlimChunksDTO extends Array<GroupSlimChunksDTO> {
}
/**
 * 
 * @export
 * @interface RecommendSlimChunkMetadata
 */
export interface RecommendSlimChunkMetadata extends Array<SlimChunkMetadata> {
}
/**
 * 
 * @export
...
export const ChunkGroupApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecommendedGroups(tRDataset: string, recommendGroupChunksRequest: RecommendGroupChunksRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecommendGroupChunkResponseTypes>> {
...
export const ChunkGroupApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRecommendedGroups(tRDataset: string, recommendGroupChunksRequest: RecommendGroupChunksRequest, options?: any): AxiosPromise<RecommendGroupChunkResponseTypes> {
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deleteUserApiKey: async (apiKeyId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/user/delete_api_key/{api_key_id}`
