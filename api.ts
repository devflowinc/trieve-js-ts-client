 ...
 * @export
 */
export type ChunkMetadataTypes = ChunkMetadata | ContentChunkMetadata | SlimChunkMetadata;
...
export const ChunkApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {AutocompleteData} autocompleteData JSON request payload to semantically search for chunks (chunks)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        autocomplete: async (tRDataset: string, autocompleteData: AutocompleteData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
            assertParamExists('autocomplete', 'tRDataset', tRDataset)
            // verify required parameter 'autocompleteData' is not null or undefined
            assertParamExists('autocomplete', 'autocompleteData', autocompleteData)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(autocompleteData, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getChunksByIds: async (tRDataset: string, getChunksData: GetChunksData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getChunksByTrackingIds: async (tRDataset: string, getTrackingChunksData: GetTrackingChunksData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        searchChunks: async (tRDataset: string, searchChunkData: SearchChunkData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
            assertParamExists('searchChunks', 'tRDataset', tRDataset)
            // verify required parameter 'searchChunkData' is not null or undefined
            assertParamExists('searchChunks', 'searchChunkData', searchChunkData)
...
export const ChunkApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async autocomplete(tRDataset: string, autocompleteData: AutocompleteData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SearchChunkQueryResponseBody>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.autocomplete(tRDataset, autocompleteData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getChunksByIds(tRDataset: string, getChunksData: GetChunksData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ChunkMetadata>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getChunksByIds(tRDataset, getChunksData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getChunksByTrackingIds(tRDataset: string, getTrackingChunksData: GetTrackingChunksData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChunkMetadata>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getChunksByTrackingIds(tRDataset, getTrackingChunksData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async searchChunks(tRDataset: string, searchChunkData: SearchChunkData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SearchChunkQueryResponseBody>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchChunks(tRDataset, searchChunkData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ChunkApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        autocomplete(tRDataset: string, autocompleteData: AutocompleteData, options?: any): AxiosPromise<SearchChunkQueryResponseBody> {
            return localVarFp.autocomplete(tRDataset, autocompleteData, options).then((request) => request(axios, basePath));
        },
        /**
         * Create or Upsert Chunk or Chunks  Create a new chunk. If the chunk has the same tracking_id as an existing chunk, the request will fail. Once a chunk is created, it can be searched for using the search endpoint. If uploading in bulk, the maximum amount of chunks that can be uploaded at once is 120 chunks.
         * @summary Create or Upsert Chunk or Chunks
         ...
         * @throws {RequiredError}
         */
        getChunksByIds(tRDataset: string, getChunksData: GetChunksData, options?: any): AxiosPromise<Array<ChunkMetadata>> {
            return localVarFp.getChunksByIds(tRDataset, getChunksData, options).then((request) => request(axios, basePath));
        },
        /**
         * Get Chunks By TrackingIds  Get multiple chunks by ids.
         * @summary Get Chunks By TrackingIds
         ...
         * @throws {RequiredError}
         */
        getChunksByTrackingIds(tRDataset: string, getTrackingChunksData: GetTrackingChunksData, options?: any): AxiosPromise<ChunkMetadata> {
            return localVarFp.getChunksByTrackingIds(tRDataset, getTrackingChunksData, options).then((request) => request(axios, basePath));
        },
        /**
         * Get Recommended Chunks  Get recommendations of chunks similar to the chunks in the request. Think about this as a feature similar to the \"add to playlist\" recommendation feature on Spotify. This request pairs especially well with our groups endpoint.
         * @summary Get Recommended Chunks
         ...
         * @throws {RequiredError}
         */
        searchChunks(tRDataset: string, searchChunkData: SearchChunkData, options?: any): AxiosPromise<SearchChunkQueryResponseBody> {
            return localVarFp.searchChunks(tRDataset, searchChunkData, options).then((request) => request(axios, basePath));
        },
        /**
         * Update Chunk  Update a chunk. If you try to change the tracking_id of the chunk to have the same tracking_id as an existing chunk, the request will fail.
         * @summary Update Chunk
...
export class ChunkApi extends BaseAPI {
     ...
     * @memberof ChunkApi
     */
    public autocomplete(tRDataset: string, autocompleteData: AutocompleteData, options?: RawAxiosRequestConfig) {
        return ChunkApiFp(this.configuration).autocomplete(tRDataset, autocompleteData, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ChunkApi
     */
    public getChunksByIds(tRDataset: string, getChunksData: GetChunksData, options?: RawAxiosRequestConfig) {
        return ChunkApiFp(this.configuration).getChunksByIds(tRDataset, getChunksData, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ChunkApi
     */
    public getChunksByTrackingIds(tRDataset: string, getTrackingChunksData: GetTrackingChunksData, options?: RawAxiosRequestConfig) {
        return ChunkApiFp(this.configuration).getChunksByTrackingIds(tRDataset, getTrackingChunksData, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ChunkApi
     */
    public searchChunks(tRDataset: string, searchChunkData: SearchChunkData, options?: RawAxiosRequestConfig) {
        return ChunkApiFp(this.configuration).searchChunks(tRDataset, searchChunkData, options).then((request) => request(this.axios, this.basePath));
    }
...
export const FileApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteFileHandler: async (tRDataset: string, fileId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tRDataset' is not null or undefined
...
export const FileApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteFileHandler(tRDataset: string, fileId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteFileHandler(tRDataset, fileId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const FileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteFileHandler(tRDataset: string, fileId: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteFileHandler(tRDataset, fileId, options).then((request) => request(axios, basePath));
        },
        /**
         * Get Files for Dataset  Get all files which belong to a given dataset specified by the dataset_id parameter. 10 files are returned per page.
         * @summary Get Files for Dataset
...
export class FileApi extends BaseAPI {
     ...
     * @memberof FileApi
     */
    public deleteFileHandler(tRDataset: string, fileId: string, options?: RawAxiosRequestConfig) {
        return FileApiFp(this.configuration).deleteFileHandler(tRDataset, fileId, options).then((request) => request(this.axios, this.basePath));
    }
