  ...
  return {
    ...
    async getRecommendedChunks(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ChunkMetadataWithFileData>>
    > {
      const localVarAxiosArgs =
    ...
    async searchChunk(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SearchChunkQueryResponseBody>
    > {
  ...
  return {
    ...
    async getRecommendedGroups(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<GroupScoreChunkDTO>>
    > {
      const localVarAxiosArgs =
    ...
    async searchWithinGroup(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SearchGroupsResult>
    > {
      const localVarAxiosArgs =
